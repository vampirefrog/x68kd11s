...
;  519 Labels
;
;  Commandline dis  -b2 -h -m68000 --sp -q1 -B -M -o120 -w16 -gsound/mopmdrv.lab -Tsound/mopmdrv.tab --overwrite sound/mopmdrv.x sound/mopmdrv.s
;          DIS version 3.16
;=============================================
...
L000fc4:
	.dc.w	$0016,$001b,$0020,$0026,$0028,$002f,$0031,$0036
	.dc.w	$0038,$003d,$0040
UnknownBlob2:
	.dc.b	$44,$2e,$43,$2e,$00,$44,$2e,$53,$2e,$00,$53,$45,$47,$4e,$4f,$00
	.dc.b	$24,$00,$54,$4f,$43,$4f,$44,$41,$00,$2a,$00,$46,$49,$4e,$45,$00
	.dc.b	$5e,$00,$43,$4f,$44,$41,$00,$44,$4f,$00,$4c,$4f,$4f,$50,$00,$00
L00100a:
	cmpi.b	#$3a,(a0)		;':'
	bne.s	L00104a
	addq.l	#1,a0
...
L001742:
	.dc.b	$06,$08,$fd,$ff,$01,$02,$04,$00,$2f,$01,$70,$00,$72,$00
L001750:
	bsr.w	L001604
	cmpi.b	#$30,(a0)+		;'0'
	beq.s	L001750
...
L001d00:
	.dc.w	$00f8,$008e,$00aa,$00ba,$027a,$00d0,$00d8,$0198
...
Ins2:
	...
	.dc.b	$0f ; Slot Mask
	.dc.b	$02,$00,$de,$1e,$0a,$00,$00,$03,$00
	.dc.b	$1f,$0a,$01,$03,$0f,$1d,$00,$07,$03,$00,$00
	.dc.b	$1d,$0c,$09,$07,$0a,$00,$00,$07,$07,$00,$01
	.dc.b	$1f,$05,$01,$03,$0f,$27,$02,$05,$03,$01,$00
	.dc.b	$1c,$0c,$09,$07,$0a,$00,$00,$07,$03,$00,$01
Ins3:
	.dc.b	$03 << 3 | $04 ; Feedback << 3 | Connection
	.dc.b	$0f ; Slot Mask
