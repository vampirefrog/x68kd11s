;=============================================
;  Filename human302/bin/chkdsk.x
;
;
;  Base address 000000
;  Exec address 000000
...
;  114 Labels
;
;  Commandline dis  -h -k -m68000 -q1 -B -M -w16 -o120 -ghuman302/bin/chkdsk.lab --overwrite human302/bin/chkdsk.x human302/bin/chkdsk.s
;          DIS version 3.16
;=============================================
